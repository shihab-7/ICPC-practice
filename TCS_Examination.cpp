...
int main()
{
    ...
    test{
        ...
        if(drago > slo) cout<<"DRAGON"<<endl;
        else if(drago < slo) cout<<"SLOTH"<<endl;
        else
        {
            if(v1[0] > v2[0]) cout<<"DRAGON"<<endl;
            else if(v1[0] < v2[0]) cout<<"SLOTH"<<endl;
            else if(v1[1] > v2[1]) cout<<"DRAGON"<<endl;
            else if(v1[1] < v2[1]) cout<<"SLOTH"<<endl;
            else if(v1[2] > v2[2]) cout<<"DRAGON"<<endl;
            else if(v1[2] < v2[2]) cout<<"SLOTH"<<endl;
            else cout<<"TIE"<<endl;
        }
    }
    return 0;

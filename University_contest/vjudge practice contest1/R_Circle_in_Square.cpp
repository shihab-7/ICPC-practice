...
int main()
{
    ...
    test
    {
        ...
        double rad;
        cin >> rad;
        double one_side = 2*rad;
        double s_area= one_side * one_side;
        double c_area= pi*(rad*rad);
        double rest_area=s_area - c_area;
        rest_area += 1e-9;
        cout<<fixed<<setprecision(2)<<"Case "<<i<<": "<<rest_area<<endl;
    }
    return 0;
}